...
using WarehouseOperative.ViewModels.BuisnessLogicViewModel;
    ...
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        private List<CommandViewModel> CreateCommands()
        {
            ...
            return new List<CommandViewModel>
            {
                ...
                new CommandViewModel("Profit Report", new BaseCommand(()=>showAll<OrdersReportViewModel>()),"pack://application:,,,/Views/Content/Icons/profitreport.png"),
                new CommandViewModel("Product Report", new BaseCommand(()=>showAll<ProductBViewModel>()),"pack://application:,,,/Views/Content/Icons/productreport.png"),
                new CommandViewModel("Client Report", new BaseCommand(()=>showAll<CustomerBViewModel>()),"pack://application:,,,/Views/Content/Icons/customerreport.png")
            };
        }
        #endregion
